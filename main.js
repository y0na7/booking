...
const DB_USER = process.env.DB_USER || "rzjmjpyd";
const DB_HOST = process.env.DB_HOST || "hattie.db.elephantsql.com";
const DB_NAME = process.env.DB_NAME || "rzjmjpyd";
const DB_PW = process.env.DB_PW || "3RWgn5u9HmKBhEBKhrjv-GTuZ-ixaIvF";
